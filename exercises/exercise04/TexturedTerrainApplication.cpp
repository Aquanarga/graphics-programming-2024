...
void TexturedTerrainApplication::Render()
{
    ...
    DrawObject(m_terrainPatch, *m_terrainMaterial01, glm::scale(glm::vec3(10.0f)) * glm::translate(glm::vec3(0.0f, 0.0f, -1.0f)));
...
void TexturedTerrainApplication::InitializeTextures()
{
    ...
    m_heightmapTexture00 = CreateHeightMap(128, 128, glm::ivec2(0, 0));
    m_heightmapTexture01 = CreateHeightMap(128, 128, glm::ivec2(0, -1));
    m_heightmapTexture10 = CreateHeightMap(128, 128, glm::ivec2(-1, 0));
    m_heightmapTexture11 = CreateHeightMap(128, 128, glm::ivec2(-1, -1));
...
std::shared_ptr<Texture2DObject> TexturedTerrainApplication::CreateHeightMap(unsigned int width, unsigned int height, glm::ivec2 coords)
{
    ...
    for (unsigned int j = 0; j < height; ++j)
    {
        for (unsigned int i = 0; i < width; ++i)
        {
            ...
            float r = stb_perlin_fbm_noise3(x, y, 0.0f, 1.9f, 0.5f, 8) * 0.5f;
            pixels.push_back(r);
        }
    }
